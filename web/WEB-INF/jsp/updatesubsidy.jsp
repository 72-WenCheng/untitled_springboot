...
<c:forEach items="${list}" var="c">
  <div id="all">
    ...
    <form action="updatesubsidytll" method="post" name="tll" onsubmit="return false">
      <span>补贴名称：</span>
      ...
      <br>
      <span>补贴年月：</span><input type="date" name="subsidytime" placeholder="${c.subsidytime}" id="subsidytime" style="width: 150px;height: 30px;">&nbsp;&nbsp;&nbsp;时间格式：<fmt:formatDate value="${c.subsidytime}" pattern="yyyy-MM-dd"/><br>
