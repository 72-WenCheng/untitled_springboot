...
<div id="all">
    <span>你当前的位置：【员工管理】-【员工信息管理】-【员工信息修改】</span>
    <form action="updateemployeetll" method="post" name="tll" onsubmit="return false">
    <c:forEach items="${list1}" var="a">
        <span>员工工号：</span><input type="text" name="jobnumber" id="jobnumber" placeholder="${a.jobnumber}" style="width: 200px;height: 30px;"><br>
        <span>员工密码：</span><input type="text" name="password" id="password" placeholder="${a.password}" style="width: 200px;height: 30px;"><br>
    </c:forEach>
        <span>员工姓名：</span><input type="text" name="employeename" id="employeename" placeholder="${c.employeename}" style="width: 200px;height: 30px;"><br>
        <span>性别：</span>
        <select id="xiala1" name="sex" placeholder="${c.sex}">
        ...
        <br>
        <span>等级名称：</span>
        <select id="xiala2" name="gradename" placeholder="${c.gradename}">
            <option value="" disabled selected hidden>请选择</option>
        ...
        <br>
        <span>角色名称：</span>
        <select id="xiala3" name="rolename" placeholder="${c.rolename}">
            <option value="" disabled selected hidden>请选择</option>
        ...
        <br>
        <span>所属店铺：</span>
        <select id="xiala4" name="shopname" placeholder="${c.shopname}">
            <option value="" disabled selected hidden>请选择</option>
        ...
        <br>
        <span>所属部门：</span>
        <select id="xiala5" name="departmentname" placeholder="${c.departmentname}">
            <option value="" disabled selected hidden>请选择</option>
        ...
        <br>
        <span>状态：</span>
        <select id="xiala6" name="state" placeholder="${c.state}">
            <option value="" disabled selected hidden>请选择</option>
        ...
        <br>
        <span>地址：</span><input type="text" name="location" id="location" placeholder="${c.location}" style="width: 200px;height: 30px;"><br>
        <span>电话号码：</span><input type="text" name="number" id="number" placeholder="${c.number}" style="width: 200px;height: 30px;"><br>
        <span>邮箱：</span><input type="text" name="email" id="email" placeholder="${c.email}" style="width: 200px;height: 30px;"><br>
